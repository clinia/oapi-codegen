...
import (
	...
	examplePetstoreClient "github.com/clinia/oapi-codegen/examples/petstore-expanded"
	examplePetstore "github.com/clinia/oapi-codegen/examples/petstore-expanded/echo/api"
	"github.com/clinia/oapi-codegen/pkg/util"
...
const (
	remoteRefFile = `https://raw.githubusercontent.com/clinia/oapi-codegen/master/examples/petstore-expanded` +
		`/petstore-expanded.yaml`
	remoteRefImport = `github.com/clinia/oapi-codegen/examples/petstore-expanded`
)
...
func TestRemoteExternalReference(t *testing.T) {
	...
	// Check import
	assert.Contains(t, code, `externalRef0 "github.com/clinia/oapi-codegen/examples/petstore-expanded"`)
